...
class ProfileActivity: AppCompatActivity() {
    ...
    private val RC_FROM_PROFILEACTIVITY = 11111
    ...
    fun onMovieCardClicked(view: View){
        val intent = MovieDetailActivity.newIntent(this,rating)
        startActivityForResult(intent,RC_FROM_PROFILEACTIVITY)
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data)
        if(requestCode == RC_FROM_PROFILEACTIVITY && resultCode == Activity.RESULT_OK && data != null)
        {
